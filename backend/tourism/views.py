...
from tourism.serializers import TouristSpotSerializer, ThrillingAdventureSerializer, CultureSerializer  # ✅ Correct
from tourism.models import Destination, TouristSpot, ThrillingAdventure, Culture  # ✅ Correct
